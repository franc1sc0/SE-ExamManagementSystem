...
There are two type of users \index{user} who will be using the application: Faculty members
...
For both types of users, no previous training \index{training} or specialization should be
